/** @file ffs_linux_configuration_map.h
 *
...
#ifndef FFS_LINUX_CONFIGURATION_MAP_H_
#define FFS_LINUX_CONFIGURATION_MAP_H_
 ...
 */
typedef struct FfsLinuxConfigurationMap_s {
...
#endif /* FFS_LINUX_CONFIGURATION_MAP_H_ */
