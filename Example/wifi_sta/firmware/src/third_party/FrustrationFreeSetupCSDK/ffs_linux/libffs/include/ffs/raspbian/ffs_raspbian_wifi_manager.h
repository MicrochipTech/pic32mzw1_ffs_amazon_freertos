/** @file ffs_raspbian_wifi_manager.h
 *
 * @brief Raspbian Wi-Fi manager API.
 *
...
#ifndef FFS_RASPBIAN_WIFI_MANAGER_H_
#define FFS_RASPBIAN_WIFI_MANAGER_H_
 ...
 * @returns Enumerated [result](@ref FFS_RESULT)
 */
FFS_RESULT ffsRaspbianDeinitializeWifiManager(struct FfsUserContext_s *userContext,
 ...
 * @returns Enumerated [result](@ref FFS_RESULT)
 */
FFS_RESULT ffsRaspbianWifiManagerConnect(const char *wpaSupplicantConfigurationFile,
        FfsStream_t *hostNameStream, FfsWifiManagerCallback_t callback);
...
#endif /* FFS_RASPBIAN_WIFI_MANAGER_H_ */
